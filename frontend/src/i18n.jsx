...
const dict = {
  en: {
    ...
    inStock: 'In stock',
    totalStock: 'Total stock: {n}',
    stockMatrix: 'Stock by color & size',
    total: 'Total',
    searchAria: 'Search',
    searchTitle: 'Search',
    ...
    shippingIntro: 'Where should we send your order?',
    shipName: 'Full name',
    shipAddress: 'Delivery address',
    shipPhone: 'Contact number',
    shipRequired: 'Please fill in every field.',
    shipTo: 'Ship to',
    continueWa: 'Continue to WhatsApp',
    cancel: 'Cancel',
  },
  id: {
    cart: 'Tas',
    ...
    lowStock: 'Tersisa {n}',
    inStock: 'Tersedia',
    totalStock: 'Total stok: {n}',
    stockMatrix: 'Stok per warna & ukuran',
    total: 'Total',
    searchAria: 'Cari',
    searchTitle: 'Cari',
    ...
    noResults: 'Tidak ada pieces yang cocok dengan pencarian Anda.',
    resultsCount: '{n} hasil',
    shippingTitle: 'Detail pengiriman',
    shippingIntro: 'Ke mana pesanan Anda dikirim?',
    shipName: 'Nama lengkap',
    shipAddress: 'Alamat pengiriman',
    shipPhone: 'Nomor kontak',
    shipRequired: 'Mohon isi semua kolom.',
    shipTo: 'Kirim ke',
