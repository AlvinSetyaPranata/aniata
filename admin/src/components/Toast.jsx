...
export function ToastProvider({ children }) {
  ...
  const toast = useCallback(
    (message) => {
      ...
      setToasts((prev) => prev.slice(-MAX_STACK + 1).concat({ id, message }))
...
function ToastItem({ toast, onClose }) {
  return (
    <div className="pointer-events-auto w-full overflow-hidden rounded-[3px] border border-line bg-surface text-ink shadow-[0_10px_34px_rgba(21,19,14,0.14)] motion-safe:animate-[pd-rise_300ms_cubic-bezier(0.22,1,0.36,1)]">
